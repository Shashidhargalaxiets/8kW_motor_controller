...
#define _PORT_PM10_DEFAULT_VALUE                  (0x0000U) /* PM10 default value */
#define _PORT_PIS9_DEFAULT_VALUE                  (0xFF80U) /* PIS9 default value */
#define _PORT_PIS10_DEFAULT_VALUE                 (0x0000U) /* PIS10 default value */
...
/**
****************************************************************************************************************************
* Function Name: PWM_R_Pins_Create
* Description  : This function initializes the PWM Pins.
* Arguments    : None
* Return Value : None
****************************************************************************************************************************
**/
...
/**
****************************************************************************************************************************
* Function Name: Config_CAN_PORT
* Description  : This function initializes the CAN Pins.
* Arguments    : None
* Return Value : None
****************************************************************************************************************************
**/
