...
{  
    ...
    CLKCTL.PLL1C = 0x0001803B; /* Division Valu of Nr is 3B(Nr=60), Mr is 01(Mr=2) */
    WPROTR.PROTCMD1 = _WRITE_PROTECT_COMMAND;
    ...
    CLKCTL.CKSC_ICANOSCD_STPM = _CGC_CKSC_ICANOSCD_STPM_DEFAULT_VALUE | _CGC_RSCANOSC_CLK_REQUEST_CONTINUE;
