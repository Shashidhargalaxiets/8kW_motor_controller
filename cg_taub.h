...
*/
/* Selection of TAUBTTIN15 input signal (SELB_TAUBnI15)*/
#define _TAUB_INPUT_SIGNAL_CH15_TAUBI14                     (0x8000U) /* TAUBnI14 is selected */
/* Selection of TAUBTTIN14 input signal (SELB_TAUBnI14) */
#define _TAUB_INPUT_SIGNAL_CH14_TAUBI15                     (0x4000U) /* TAUBnI15 is selected */
/* Selection of TAUBTTIN13 input signal (SELB_TAUBnI13) */
#define _TAUB_INPUT_SIGNAL_CH13_TAUBI12                     (0x2000U) /* TAUBnI12 is selected */
/* Selection of TAUBTTIN12 input signal (SELB_TAUBnI12) */
#define _TAUB_INPUT_SIGNAL_CH12_TAUBI13                     (0x1000U) /* TAUBnI13 is selected */
/* Selection of TAUBTTIN11 input signal (SELB_TAUBnI11) */
#define _TAUB_INPUT_SIGNAL_CH11_TAUBI10                     (0x0800U) /* TAUBnI10 is selected */
/* Selection of TAUBTTIN10 input signal (SELB_TAUBnI10) */
#define _TAUB_INPUT_SIGNAL_CH10_TAUBI11                     (0x0400U) /* TAUBnI11 is selected */
/* Selection of TAUBTTIN9 input signal (SELB_TAUBnI9) */
#define _TAUB_INPUT_SIGNAL_CH9_TAUBI8                       (0x0200U) /* TAUBnI8 is selected */
/* Selection of TAUBTTIN8 input signal (SELB_TAUBnI8) */
#define _TAUB_INPUT_SIGNAL_CH8_TAUBI9                       (0x0100U) /* TAUBnI9 is selected */
/* Selection of TAUBTTIN7 input signal (SELB_TAUBnI7)*/
#define _TAUB_INPUT_SIGNAL_CH7_TAUBI6                       (0x0080U) /* TAUBnI6 is selected */
/* Selection of TAUBTTIN6 input signal (SELB_TAUBnI6) */
#define _TAUB_INPUT_SIGNAL_CH6_TAUBI7                       (0x0040U) /* TAUBnI7 is selected */
/* Selection of TAUBTTIN5 input signal (SELB_TAUBnI5) */
#define _TAUB_INPUT_SIGNAL_CH5_TAUBI4                       (0x0020U) /* TAUBnI4 is selected */
/* Selection of TAUBTTIN4 input signal (SELB_TAUBnI4) */
#define _TAUB_INPUT_SIGNAL_CH4_TAUBI5                       (0x0010U) /* TAUBnI5 is selected */
/* Selection of TAUBTTIN3 input signal (SELB_TAUBnI3) */
#define _TAUB_INPUT_SIGNAL_CH3_TAUBI2                       (0x0008U) /* TAUBnI2 is selected */
/* Selection of TAUBTTIN2 input signal (SELB_TAUBnI2) */
#define _TAUB_INPUT_SIGNAL_CH2_TAUBI3                       (0x0004U) /* TAUBnI3 is selected */
/* Selection of TAUBTTIN1 input signal (SELB_TAUBnI1) */
#define _TAUB_INPUT_SIGNAL_CH1_TAUBI0                       (0x0002U) /* TAUBnI0 is selected */
/* Selection of TAUBTTIN0 input signal (SELB_TAUBnI0) */
#define _TAUB_INPUT_SIGNAL_CH0_TAUBI1                       (0x0001U) /* TAUBnI1 is selected */

/*
    TAUBn Prescaler Clock Select Register (TAUBnTPS)
*/
/* Specifies the CK3 clock (TAUBnPRS3[3:0]) */
...
/* Specifies the CK2 clock (TAUBnPRS2[3:0]) */
...
/* Specifies the CK1 clock (TAUBnPRS1[3:0]) */
...
/* Specifies the CK0 clock (TAUBnPRS0[3:0]) */
...
*/
/* Selects the operation clock (TAUBnCKS[1:0]) */
...
/* Selects the count clock for TAUBnCNTm counter (TAUBnCCS0) */
...
/* Specifies a master or slave channel during synchronous channel operation (TAUBnMAS) */
#define _TAUB_INDEPENDENT_CHANNEL                           (0x0000U) /* Independent channel */
...
#define _TAUB_VALID_REVERSE_EDGE_HARDWARE                   (0x0200U) /* Valid edge used as a start/stop trigger */
#define _TAUB_MASTER_START                                  (0x0400U) /* INTTAUBnIm of master channel */
#define _TAUB_MASTER_SETTING                                (0x0500U) /* INTTAUBnIm of upper channel (m - 1) */
#define _TAUB_OUTPUT_UPPER                                  (0x0600U) /* Dead-time output signal */
#define _TAUB_MASTER_OUTPUT_TRIGGER_SIGNAL                  (0x0700U) /* Up/down output trigger signal */
/* Specifies the timing for updating capture register and the overflow flag (TAUBnCOS[1:0]) */
#define _TAUB_OVERFLOW_AUTO_CLEAR                           (0x0000U) /* TAUBnOVF is set by TAUBnTTINm valid edge */
#define _TAUB_OVERFLOW_MANUAL_CLEAR                         (0x0040U) /* TAUBnOVF is set by TAUBnCLOV */
#define _TAUB_OVERFLOW_COUNT_STOP                           (0x0080U) /* Counter update, TAUBnOVF is not set */
#define _TAUB_OVERFLOW_COUNT_STOP_MANUAL_CLEAR              (0x00C0U) /* Counter update, TAUBnOVF is set by TAUBnCLOV */
/* Specifies the operation mode (TAUBnMD[4:1]) */
...
#define _TAUB_OUTPUT_IN_SIGNAL_WIDTH                        (0x0000U) /* INTTAUBnIm output in signal width */
...
#define _TAUB_OUTPUT_OVER_SIGNAL_WIDTH                      (0x0001U) /* INTTAUBnIm output over signal width */
...
#define _TAUB_INPUT_EDGE_BOTH_MEASURE_LOW                   (0x02U) /* Both edges (selects low width measurement) */
#define _TAUB_INPUT_EDGE_BOTH_MEASURE_HIGH                  (0x03U) /* Both edges (selects high width measurement) */
...
/*
    TAUBn Channel Status Clear Trigger Register (TAUBnCSCm)
*/
/* Clearing the overflow flag TAUBnCSRm.TAUBnOVF of channel m (TAUBnCLOV) */
#define _TAUB_OVERFLOW_FLAG_CLEAR                           (0x01U) /* Clears overflow flag */
